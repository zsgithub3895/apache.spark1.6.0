...
public class JedisClusterPipeline extends PipelineBase implements Closeable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //10.223.138.128:7001,10.223.138.128:7002,10.223.138.128:7003,10.223.138.128:7004,10.223.138.128:7005,10.223.138.128:7006
        nodes.add(new HostAndPort("10.223.138.128", 7001));
        nodes.add(new HostAndPort("10.223.138.128", 7002));
        nodes.add(new HostAndPort("10.223.138.128", 7003));
        //nodes.add(new HostAndPort("10.223.138.128", 7004));
        //nodes.add(new HostAndPort("10.223.138.128", 7005));
        //nodes.add(new HostAndPort("10.223.138.128", 7006));
        ...
        System.out.println("+++dbSize="+batchResult.size());
